...
DoriosAPI.register.blockComponent('poop_generator', {
...
§r§cRate ${Energy.formatEnergyToText(generator.baseRate)}/t
                ...
                // Only accept poop as valid fuel
                const fuel = poopFuels.find(f => item?.typeId.includes(f.id));
                if (!fuel) {
                    generator.setLabel(`
§r§eInvalid Fuel
