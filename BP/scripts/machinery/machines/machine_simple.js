...
import { biomaceratorRecipes } from "../../config/recipes/biomacerator.js";

import { smelterRecipes } from "../../config/recipes/smelter.js";

import { scrapperRecipes } from "../../config/recipes/scrapper.js";



const UTILITYCRAFT_RECIPES = {

    'biomacerator': biomaceratorRecipes,

    'smelter': smelterRecipes,

    'scrapper': scrapperRecipes
