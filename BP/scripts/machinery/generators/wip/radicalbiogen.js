...
import { radicalbioFuels } from "../../../config/recipes/fuels.js";

const COLORS = DoriosAPI.constants.textColors

DoriosAPI.register.blockComponent('radical_bio_generator', {
...
§r§cRate ${Energy.formatEnergyToText(generator.baseRate)}/t
                ...
                const fuel = radicalbioFuels.find(f => item?.typeId.includes(f.id));
                if (!fuel) {
                    generator.setLabel(`
§r§eInvalid Fuel
