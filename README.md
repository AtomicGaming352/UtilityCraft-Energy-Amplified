...
Bio generator
-has 4 tiers, uses organic materials to generate DE, special items like the biowaste,compost,and biomass are used in this generator
Biowaste generator
-has 4 tiers, upgraded version of Bio generator, only uses biowaste and compost yet multiplies the DE output of biowaste by 2.5x and multiplies the DE output of compost by 3x
Advanced solar panels(T2 panels)
-has 4 tiers, same as tier 1 solar panel but generates 5x the DE of a normal solar panel
Lunar panel
-has 4 tiers, same as a tier 1 solar panel but instead of generating DE in daytime it instead generates DE in nighttime

Machines included in 1.0:
...
Biomass
-a new way of getting DE by putting it in the Bio generator, obtained by crafting or through the bio macerator
Compost
